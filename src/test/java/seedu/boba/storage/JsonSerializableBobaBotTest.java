...
import seedu.boba.testutil.TypicalPersons;
...
public class JsonSerializableBobaBotTest {
    ...
    private static final Path TYPICAL_PERSONS_FILE = TEST_DATA_FOLDER.resolve("typicalPersonsBobaBot.json");
    private static final Path INVALID_PERSON_FILE = TEST_DATA_FOLDER.resolve("invalidPersonBobaBot.json");
    private static final Path DUPLICATE_PERSON_FILE = TEST_DATA_FOLDER.resolve("duplicatePersonBobaBot.json");
    ...
    public void toModelType_typicalPersonsFile_success() throws Exception {
        ...
        BobaBot typicalPersonsBobaBot = TypicalPersons.getTypicalBobaBot();
