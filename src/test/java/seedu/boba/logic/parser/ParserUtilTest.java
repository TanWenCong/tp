...
public class ParserUtilTest {
    ...
    private static final String VALID_REWARD = "6900";
    ...
    @Test
    public void parseReward_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseReward(INVALID_REWARD));
    }

    @Test
    public void parseReward_validValueWithoutWhitespace_returnsReward() throws Exception {
        Reward expectedReward = new Reward(VALID_REWARD);
        assertEquals(expectedReward, ParserUtil.parseReward(VALID_REWARD));
    }

    @Test
    public void parseReward_validValueWithWhitespace_returnsTrimmedReward() throws Exception {
        String rewardWithWhitespace = WHITESPACE + VALID_REWARD + WHITESPACE;
        Reward expectedReward = new Reward(VALID_REWARD);
        assertEquals(expectedReward, ParserUtil.parseReward(rewardWithWhitespace));
    }
