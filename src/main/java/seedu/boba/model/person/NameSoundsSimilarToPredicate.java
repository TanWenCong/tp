...
public class NameSoundsSimilarToPredicate implements Predicate<Person> {
    ...
    public boolean equals(Object other) {
        return other == this // short circuit if same object
                || (other instanceof seedu.boba.model.person.NameSoundsSimilarToPredicate // instanceof handles nulls
                && keywords.equals((
                        (seedu.boba.model.person.NameSoundsSimilarToPredicate) other).keywords
                )); // state check
    }
